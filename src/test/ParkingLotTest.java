...
public class ParkingLotTest {
    ...
    public void testForCarParking(){
        Car c = new Car(1, Car.CAR_TYPE.NORMAL);
    ...
    public void testIfParkingLotIsFull(){
        Car carFirst = new Car(1, Car.CAR_TYPE.NORMAL);
        Car carSecond = new Car(2, Car.CAR_TYPE.NORMAL);
        Car carThird = new Car(3, Car.CAR_TYPE.NORMAL);
    ...
    public void testFbiIsNotifiedWhenParking80percentFull() {
         ...
         Car carSecond = new Car(2, Car.CAR_TYPE.NORMAL);
         Car carThird = new Car(3, Car.CAR_TYPE.NORMAL);
         Car carFourth = new Car(4, Car.CAR_TYPE.NORMAL);
